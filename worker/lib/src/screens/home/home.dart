  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      ...
      body: RefreshIndicator.adaptive(
        onRefresh: () async => ref.invalidate(getTasksProvider),
                  ...
                  data: (data) {
                    ...
                    return Column(
                      children: [
                          ...
                          child: Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                Expanded(
                                  child: Text(
                                    context.tr.todaysTaskAlmostDone,
                                    style: const TextStyle(
                        ...
                        calculatePercentage(tasks, finishedTasks) != "100"
                            ? Container(
                                color: Colors.white,

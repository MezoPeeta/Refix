...
abstract class AppLocalizations {
  ...
  /// No description provided for @theDetails.
  ///
  /// In en, this message translates to:
  /// **'The details'**
  String get theDetails;

  /// No description provided for @clickOnMap.
  ///
  /// In en, this message translates to:
  /// **'Click on the map to go to Google Maps and start navigating to the client.'**
  String get clickOnMap;

  /// No description provided for @startTaskNow.
  ///
  /// In en, this message translates to:
  /// **'Start Task Now'**
  String get startTaskNow;

  /// No description provided for @todaysTaskAlmostDone.
  ///
  /// In en, this message translates to:
  /// **'Your today\'s task almost done!'**
  String get todaysTaskAlmostDone;
  ...
  /// No description provided for @finishWork.
  ///
  /// In en, this message translates to:
  /// **'Finish Work'**
  ...
  /// No description provided for @pressCallButton.
  ///
  /// In en, this message translates to:
  /// **'Press the call button to contact the client directly'**
  String get pressCallButton;

  /// No description provided for @startInspectionProcess.
  ///
  /// In en, this message translates to:
  /// **'Start The Inspection Process'**
  String get startInspectionProcess;

  /// No description provided for @photosAfterRepair.
  ///
  /// In en, this message translates to:
  /// **'Photos after repair'**
  String get photosAfterRepair;
  ...
  /// No description provided for @showAllTasks.
  ///
  /// In en, this message translates to:
  /// **'Show All Tasks'**
  String get showAllTasks;

  /// No description provided for @taskCompletionMessage.
  ///
  /// In en, this message translates to:
  /// **'Well done on completing the task! Move on to the next task and finish the remaining work. Good luck!'**
  String get taskCompletionMessage;
